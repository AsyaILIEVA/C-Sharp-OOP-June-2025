...
namespace FootballManager.Core
{
    public class Controller : IController
    {
        ...
        public string PromoteTeam(string droppingTeamName, string promotingTeamName, string managerTypeName, string managerName)
        {
            ...
            {
                return string.Format(OutputMessages.DroppingTeamDoesNotExist,
                    droppingTeamName);
            }

            if (championship.Exists(promotingTeamName))
            {
                return string.Format(OutputMessages.TeamWithSameNameExisting,
                    promotingTeamName);
            }
        ...
        public string SignManager(string teamName, string managerTypeName, string managerName)
        {
            ...
            {
                return string.Format(OutputMessages.TeamSignedWithAnotherManager,
                    teamName, team.TeamManager.Name);
            }
            ...
            return string.Format(OutputMessages.TeamSuccessfullySignedWithManager, 
